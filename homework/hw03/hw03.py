...
def replace_leaf(t, find_value, replace_value):
    ...
    for branch in branches(t):
        res += [replace_leaf(branch, find_value, replace_value)]
...
def quadratic(x, a, b, c):
    ...
    if e < lower_bound(x) or e > upper_bound(x):
        return interval(
    ...
    return interval(
        min(f(upper_bound(x)), f(lower_bound(x)), f(e)),
        max(f(upper_bound(x)), f(lower_bound(x)), f(e))
    )
